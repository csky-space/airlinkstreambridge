...
void RtpSender::sendData(std::vector<uint8_t> &data) { strm->push_frame(data.data(), data.size(), RTP_NO_FLAGS); }

void RtpSender::sendData(std::vector<uint8_t> &&data) { strm->push_frame(data.data(), data.size(), RTP_NO_FLAGS); }

void RtpSender::sendData(std::vector<uint8_t> &data) const { strm->push_frame(data.data(), data.size(), RTP_NO_FLAGS); }
